...
public class runnerSecondLab {
    ...
    public static void main(String[] args) {
        ...
        // Давайте перевіримо, чи розміри цієї матриці не перевищують 20 на 20
        if (width > 20 || height > 20) {
            System.out.println("Розміри матриці не повинні перевищувати 20 на 20.");
            return;
        }
        ...
        if (choiseUser == 1) {
            ...
            System.out.println("Помилка, такого варіанту не існує");
        }
        // Вивід результатів
        System.out.println("Матриця:");
        printMatrix(matrix);
        System.out.println("Мінімальний елемент матриці: " + findMinElementsMatrix(matrix));
        System.out.println("Максимальний елемент матриці: " + findMaxElementsMatrix(matrix));
    ...
    // Заповнення матриці рандомним способом
    ...
    // Знаходження середнього значення елемента матриці
    ...
    // Знаходження середнього11 геометричного значення елемента матриці
